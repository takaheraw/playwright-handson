...
export function ShuffleMemberForm() {
    ...
    return (
        <>
            ...
            <input type="text" ref={firstRef} id="first" name="first" placeholder="1人目の名前"/><br/>
            <label htmlFor="second">2人目</label>
            <input type="text" ref={secondRef} id="second" name="second" placeholder="2人目の名前"/><br/>
            <label htmlFor="third">3人目</label>
            <input type="text" ref={thirdRef} id="third" name="third" placeholder="3人目の名前"/><br/>
